                    ...
                    <Grid columns={2} divided>
                        <Grid.Row>
                            ...
                            <Grid.Column>
                                ...
                                <br />
                                Este sistema foi desenvolvido na disciplina de
                                Desenvolvimento para WEB III. <br /> <br />
                                Para acessar o código da <strong>API</strong> do
                                sistema, acesse:{' '}
                                <a
                                ...
                                <br /> <br />
                                Para acessar o código do{' '}
                                <strong>Módulo WEB</strong>, acesse:{' '}
                                <a
